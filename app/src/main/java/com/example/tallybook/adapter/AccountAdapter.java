...
public class AccountAdapter extends BaseAdapter {
    ...
    class ViewHolder{
        ...
        public ViewHolder(View view){
            ...
            typeTv = view.findViewById(R.id.item_mainlv_iv_title);
            timeTv = view.findViewById(R.id.item_mainlv_iv_time);
            beizhuTv = view.findViewById(R.id.item_mainlv_iv_beizhu);
            moneyTv = view.findViewById(R.id.item_mainlv_iv_money);
        }
    }
}
